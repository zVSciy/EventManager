...
db_user = os.environ.get('TICKETS_MYSQL_USER', 'test_user')
db_password = os.environ.get('TICKETS_MYSQL_PASSWORD', 'test_pw')
db_host = os.environ.get('TICKETS_MYSQL_DATABASE_HOST', 'tickets_db')
db_port = os.environ.get('TICKETS_MYSQL_DATABASE_PORT', 3306)
